...
if __name__ == "__main__":
    ...
    input_spec_required, input_spec_all, output_statuses, crd_name = parse_crd("code_gen/ack_crd_v0.3.3/sagemaker.services.k8s.aws_hyperparametertuningjobs.yaml")
